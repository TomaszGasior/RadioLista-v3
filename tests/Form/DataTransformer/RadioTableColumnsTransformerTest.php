        ...
        return [
            'case #1' => [
                ...
                [
                    ...
                    RadioTable::COLUMN_MAX_SIGNAL_LEVEL => -15,
                    RadioTable::COLUMN_RDS_PI => -16,
                    RadioTable::COLUMN_PRIVATE_NUMBER => -17,
                    RadioTable::COLUMN_COMMENT => -18,
                    RadioTable::COLUMN_EXTERNAL_ANCHOR => -19,
                ],
            ],
            ...
            'case #2' => [
                ...
                [
                    ...
                    RadioTable::COLUMN_MAX_SIGNAL_LEVEL => -15,
                    RadioTable::COLUMN_RDS_PI => -16,
                    RadioTable::COLUMN_TYPE => -17,
                    RadioTable::COLUMN_LOCALITY => -18,
                    RadioTable::COLUMN_EXTERNAL_ANCHOR => -19,
                ],
            ],
        ];

...
use App\Export\DocumentExporter;
...
use App\Row\RadioTableRowProvider;
...
class RadioTableController extends AbstractController
{
    ...
    public function show(RadioTable $radioTable, RadioTableRowProvider $radioTableRowProvider): Response
    {
        $rows = $radioTableRowProvider->findForRadioTable($radioTable);
    ...
    public function export(RadioTable $radioTable): Response
    {
        return $this->render('radio_table/export.html.twig', [
            ...
            'pdf_format_radio_stations_max_count' => DocumentExporter::PDF_FORMAT_RADIO_STATIONS_MAX_COUNT,
        ]);
    }
